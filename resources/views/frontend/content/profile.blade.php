...
<div class="user-logo">
<h3><span>Hii!!!</span>  {{auth()->user()->name}} </h3>
</div>
</div>
...
<li>
<a href="{{route('userProfile',auth()->user()->id)}}"><span  class="fas fa-list-ul mr-3"></span> Order List</a>
</li>
<li>
...
<div id="content" class="p-4 p-md-5 pt-5">
        ...
        <img  src="{{asset('/style/image/pro1.jpg')}}" alt="" class="img-fluid "/>

</div>
</div>
<script src="https://colorlib.com/etc/bootstrap-sidebar/sidebar-09/js/jquery.min.js"></script>
<script src="https://colorlib.com/etc/bootstrap-sidebar/sidebar-09/js/popper.js"></script>
<script src="https://colorlib.com/etc/bootstrap-sidebar/sidebar-09/js/bootstrap.min.js"></script>
<script src="https://colorlib.com/etc/bootstrap-sidebar/sidebar-09/js/main.js"></script>
<script defer src="https://static.cloudflareinsights.com/beacon.min.js" data-cf-beacon='{"rayId":"651d9af27fc9198c","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2021.5.1","si":10}'></script>
</body>
</html>
