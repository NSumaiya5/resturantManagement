...
@section('content')
    ...
    <main style="height:480px;" class="row d-flex align-items-center w-100 mb-5  ">
    ...
    <div class="album py-5 bg-light ">
        <div class="container">
            ...
            <div class="text-center mt-5 fs-4">
                <a class="fas fa-arrow-circle-right text-decoration-none "  style="color: #3A4256; " href="{{ route('viewMoreGallery') }}"> see more</a>
            </div>
        ...
        <div class="album py-5 bg-dark mt-5">
            <div class="container">
                ...
                <div class="text-center">
                                            ...
                                            <div class="btn-group  ">
                                                ...
                                                @else
                                                    <a class="btn btn-success fas fa-cart-arrow-downs  "
                                                        href="{{ route('login.registration.from') }}"class="">Add To Cart</a>
                    ...
                    <div class="text-center mt-5 fs-4">
                        <a class="fas fa-arrow-circle-right text-decoration-none "  style="color: #dd7140;" href="{{ route('allFoodItemMenu') }}">see more</a>
                </div>
            </div>
            ...
            <div class="album py-5 bg-light mt-5">
                <div class="container">
                    ...
                    <div class="text-center mt-5 fs-4">
                        <a class="fas fa-arrow-circle-right text-decoration-none" style="color: #3A4256;" href="{{ route('allStaffView') }}">see more</a>
                    </div>
                    <hr/>
                ...
                <div class="album py-5 bg-dark mt-5">
                    <div class="container">
                        ...
                        <div class="text-center">
                            ...
                            <h3 style="color: #dd7140;" class="mb-5 fs-2">Review</h3>
                            ...
                            <div class="row">
                                ...
                                @foreach ($review as $data)
                                    <div class=" mt-2 mb-5 col-md-4 d-flex">
