...
<div class="shopping-cart">
  ...
  <div class="product">
    <div class="product-image">
      <img src="{{url('/files/photo/'.$cart->foodItem->file)}}">
    </div>
    <div class="product-details">
      <div class="product-title">{{$cart->foodItem->name}}</div>
      <p class="product-description"> {{$cart->foodItem->description}}</p>    </div>
    <div class="product-price">{{$cart->foodItem->price}}</div>
    ...
    <div class="product-line-price">{{$cart->foodItem->price * $cart->quantity}}</div>
  </div>
  @endforeach
